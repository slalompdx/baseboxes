if "%TOOLSPATH%"=="" TOOLSPATH="http://softwareupdate.vmware.com/cds/vmw-desktop/ws/12.0.0/2985596/windows/packages/tools-windows.tar"
...
if not exist "C:\Windows\Temp\windows.iso" (
    powershell -Command "(New-Object System.Net.WebClient).DownloadFile("%TOOLSPATH%", 'C:\Windows\Temp\vmware-tools.tar')" <NUL
